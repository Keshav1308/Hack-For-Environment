#### Runbook code for stopping the Virtual Machines hosted in Azure 



This runbook will shutdown the virtual machines during the non business hours.  This runbook will be executed on the Azure Sandbox.
